...
dataplot2 <- dataplot +
  xlim(-4, 6) +
  scale_x_continuous(labels = comma, limits = c(-4, 6)) +
  theme_bw() +
  theme(
    panel.border = element_rect(colour="white"),
    plot.title = element_text(face="bold"),
...
SEPH_earnings_subtitle <- as.character("September 2018 compared to August 2018")
SEPH_earnings_caption <- as.character("Source: Statistics Canada, CANSIM table 14-10-0223-01")
SEPH_earnings_xaxis <- as.character("Month-over-month percent change")
