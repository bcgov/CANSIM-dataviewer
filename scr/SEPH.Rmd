...
data_14_10_0223_01 <- data_14_10_0223_01 %>%
    mutate(`North American Industry Classification System (NAICS)` = 
             as_factor(`North American Industry Classification System (NAICS)`)) 
...
#BC_lastmonth %>%
#  mutate(as_factor(`North American Industry Classification System (NAICS)`))
#
# this doesn't work! Generates warning
# "Unequal factor levels: coercing to characterbinding character and factor vector"
...
#BC_lastmonth %>%
#  mutate(as_factor(NAICS_desc))
#
# also does not work (see above)
