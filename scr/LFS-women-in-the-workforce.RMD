...
* Labour force characteristics by sex and detailed age group, monthly, unadjusted for seasonality (x 1,000)
...
unique(thedata$`Labour force characteristics`)
...
dataplot2 <- dataplot2 +
  labs(title = "Labour force participation, females age 25-44, British Columbia & Canada",
       ...
       caption = "Source: Statistics Canada (Labour Force Survey, CANSIM table 14-10-0017-02)", 
       x = NULL, y = "percentage")
...
For B.C. in `r max(thedata$REF_DATE)`, it was 82.4%. Nationally, it was 83.0%.
